...
def upgrade() -> None:
    ...
    op.add_column('user_config', sa.Column('enemy_color', sa.String(length=15), nullable=False, server_default = SERVER_DEFAULT_USER_CONFIG['enemy_color']))
    ...
    op.add_column('user_config', sa.Column('artifact_color', sa.String(length=15), nullable=False, server_default = SERVER_DEFAULT_USER_CONFIG['artifact_color']))
    ...
    op.add_column('user_config', sa.Column('summon_stone_color', sa.String(length=15), nullable=False, server_default = SERVER_DEFAULT_USER_CONFIG['summon_stone_color']))
    ...
    op.add_column('user_config', sa.Column('idle_reward_color', sa.String(length=15), nullable=False, server_default = SERVER_DEFAULT_USER_CONFIG['idle_reward_color']))
    op.add_column('user_config', sa.Column('empty_color', sa.String(length=15), nullable=False, server_default = SERVER_DEFAULT_USER_CONFIG['empty_color']))
    op.add_column('user_config', sa.Column('me_color', sa.String(length=15), nullable=False, server_default = SERVER_DEFAULT_USER_CONFIG['me_color']))
    op.add_column('user_config', sa.Column('unknown_color', sa.String(length=15), nullable=False, server_default = SERVER_DEFAULT_USER_CONFIG['unknown_color']))
